...
λ=9.727203192450537e-5
ε=8.470868266557403e-5
β=9.931091813749795
n_components=4
...
#function CtrlExpr(λ,  ε, β, n_components, n_pr)
    ...
    RMSETestDecoded = rmse_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:1)
...
percent = 95
predd = run_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:11)
ref_data_test
pred6 = run_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:1)[1,:,:]
...
pred6_90 = run_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:1)[1,:,:]
...
pred6_100 = run_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:1)[1,:,:]
...
pred6_80 = run_decoded(ode_prob_test, ref_params_test, probs_test, ode_prob_test.p, ref_data_test, ref_mean_train, nruns_test, 1:1)[1,:,:]
