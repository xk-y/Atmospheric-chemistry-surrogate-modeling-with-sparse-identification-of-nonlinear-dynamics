...
#bench_sindy = @benchmark 
@profview run_ensemble(ode_prob, ref_params, probs.probs, ode_prob.p)
...
JLD2.@load "benchmark_$(nruns)_$(4).jld" bench_ref_simu mean_ref_integ_timesteps bench_sindy mean_sindy_integ_timesteps
bench_ref_simu
mean_ref_integ_timesteps
bench_sindy
