...
ProjectPath = ""
    ...
    @time ref_data_spinup_train, ref_params_train = random_sims(ref_model, 3000, timelength, saveat, 1:3000);
  ...
  JLD2.jldsave(ProjectPath*"ref_data_test.jld";ref_data_test, ref_params_test, times_test)
 GC.gc()